...
public:
    ...
    int computeIk(std::vector<int>& groupHandles,double precision[2],bool forInternalFunctionality,bool(*cb)(const int*,std::vector<double>*,const int*,const int*,const int*,const int*,std::vector<double>*,double*));
